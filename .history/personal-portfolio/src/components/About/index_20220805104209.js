        ...
        <div className="container about-page">
            <div className="text-zone">
                ...
                <p>
                    ...
                    and Cloud Carib. As a co-op student, I'm always looking for an IT job position where I can use my skills and learn new ones to help improve others’ lives.
                </p>
            </div>
        </div>
    )
