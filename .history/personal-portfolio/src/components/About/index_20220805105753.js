        ...
        <div className="container about-page">
            <div className="text-zone">
                ...
                <p>
                    ...
                    Waterloo. I have a passion for web development and I’m always looking for an opportunity to learn more about software engineering, both in theory and in real-world applications.
                </p> 
                <p>
