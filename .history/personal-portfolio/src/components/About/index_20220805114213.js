        ...
        <div className="container about-page">
            ...
            <div className="stage-cube-cont">
                <div className="cubespinner">
                    ...
                    <div className="face2">
                        <FontAwesomeIcon icon={faCss3} color="#f89820" />
                    </div>
                    <div className="face3">
                        <FontAwesomeIcon icon={faSquareGit} color="#f89820" />
                    </div>
                    <div className="face4">
                        <FontAwesomeIcon icon={faHtml5} color="#f89820" />
                    </div>
                    <div className="face5">
                        <FontAwesomeIcon icon={faPython} color="#f89820" />
                    </div>
                    <div className="face6">
                        <FontAwesomeIcon icon={faReact} color="#f89820" />
                    </div>
                </div>
            </div>
        </div>
